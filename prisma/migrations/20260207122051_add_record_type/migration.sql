...
INSERT INTO "new_UnifiedRecord" ("address", "applicant", "assignedUserId", "category", "createdAt", "description", "district", "eoDate", "eoNumber", "id", "importedAt", "officerName", "resolution", "resolutionDate", "sourceFile", "updatedAt") SELECT "address", "applicant", "assignedUserId", "category", "createdAt", "description", "district", "eoDate", "eoNumber", "id", "importedAt", "officerName", "resolution", "resolutionDate", "sourceFile", "updatedAt" FROM "UnifiedRecord";

    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                weekday: "text-slate-400 font-black text-[10px] uppercase text-center w-9",
                ...
                day_button: cn(
                    ...
                    "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-primary/10 hover:text-primary rounded-lg transition-colors"
                ),
                ...
                today: "bg-slate-100 text-slate-900 font-black rounded-lg",

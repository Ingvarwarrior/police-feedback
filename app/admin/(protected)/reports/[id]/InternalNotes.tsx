    ...
    return (
        <div className="space-y-4">
            ...
            <Textarea
                ...
                className="min-h-[150px] rounded-2xl border-slate-200 font-medium text-slate-700 focus-visible:ring-primary shadow-inner bg-slate-50/50 p-4"
                value={notes}
                onChange={(e) => setNotes(e.target.value)}
                disabled={isPending || !canEdit}
            />
            <p className="text-[10px] text-slate-400 italic">Ці записи не бачать громадяни.</p>
        </div>
    )
}

...
export default function DriveClient({
    ...
    const handleDeleteFolder = async (id: string) => {
        if (!confirm('Ви впевнені, що хочете видалити цю папку? Всі файли всередині можуть бути видалені.')) return
        try {
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-slate-500 font-medium tracking-tight">Внутрішнє сховище документів</p>
                    </div>
                </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                ...
                {filteredFiles.length === 0 && filteredFolders.length === 0 && (
                    <div className="col-span-full py-20 flex flex-col items-center justify-center text-slate-400 bg-slate-50/50 rounded-[3rem] border-2 border-dashed border-slate-100 mt-4">
                        ...
                        <p className="text-[10px] mt-1 font-medium italic">Створіть папку або завантажте файл</p>
                    </div>
                )}
            </div>
        </div>
